...
/**
 * Created by ZY004Engineer on 2018/12/3.
 */
...
//        return 0;
    ...
    public static String executeCmd(final String cmd) throws IOException,
    ...
    public static boolean  executeNetCmd(final String cmd) {
        try {
            Runtime runtime = Runtime.getRuntime();
            Process proc = runtime.exec(cmd);
            int wF = proc.waitFor();
