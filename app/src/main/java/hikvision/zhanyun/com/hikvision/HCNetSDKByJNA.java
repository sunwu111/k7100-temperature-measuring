...
public interface HCNetSDKByJNA extends Library {
    ...
    public static final int NET_DVR_SET_VIDEO_INPUT_EFFECT = 1287;
    ...
    public static class NET_DVR_PRESET_NAMES extends Structure {
        public NET_DVR_PRESET_NAME[] names = (NET_DVR_PRESET_NAME[]) new NET_DVR_PRESET_NAME().toArray(300);
    ...
    public static class NET_DVR_PTZ_LIMITCOND extends Structure {
        ...
        public byte[] byRes = new byte[63];    // 是63字节，不是帮助文档上的127字节！否则调用失败
    ...
    public static class NET_DVR_PACKET_INFO_EX extends Structure {
        ...
        public long dwFrameNum;
        public long dwFrameRate;
        public long dwFlag;
        public long dwFilePos;
        public long dwPacketType;
        public long dwPacketSize;
        public byte[] pPacketBuffer;
        public byte[] byRes1 = new byte[4];
        public long dwPacketMode;
        public byte[] byRes2 = new byte[16];
        public long[] dwReserved = new long[6];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("wWidth", "wHeight", "dwTimeStamp",
                    "dwTimeStampHigh", "dwYear", "dwMonth", "dwDay", "dwHour", "dwMinute", "dwSecond", "dwMillisecond", "dwFrameNum", "dwFrameRate",
                    "dwFlag", "dwFilePos", "dwPacketType", "dwPacketSize", "pPacketBuffer", "byRes1", "dwPacketMode", "byRes2", "dwReserved");
        }
    }
    ...
    public static class NET_DVR_CRUISEPOINT_COND extends Structure {
        public int dwSize = 40;
        public int dwChan = 1;
        public short wRouteNo = 1;
        public byte[] byRes = new byte[30];
    ...
    public class NET_DVR_CRUISEPOINT_V40 extends Structure {
        public int dwSize;
        public NET_DVR_CRUISEPOINT_PARAM[] struCruisePoint = new NET_DVR_CRUISEPOINT_PARAM[128];
        public byte[] byRes = new byte[64];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "struCruisePoint", "byRes");
        }
    }
    ...
    public static class NET_DVR_VIDEO_INPUT_EFFECT extends Structure {
        public int dwSize;
        public short wEffectMode;
        public byte[] byRes1 = new byte[146];
        public NET_DVR_VIDEO_EFFECT struCustomizeMode;
        public byte[] byRes2 = new byte[60];


        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "wEffectMode", "byRes1", "struCustomizeMode", "byRes2");

        }
    }

    public static class NET_DVR_VIDEO_EFFECT extends Structure {
        public int dwBrightValue;
        public int dwContrastValue;
        public int dwSaturationValue;
        public int dwHueValue;
        public int dwSharpness;
        public int dwDenoising;
        public byte[] byRes = new byte[12];


        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwBrightValue", "dwContrastValue", "dwSaturationValue",
                    "dwHueValue", "dwSharpness", "dwDenoising", "byRes");
...
//        public NET_DVR_COLOR struColor = new NET_DVR_COLOR();
//        public byte[] byRes = new byte[32];
    ...
    public static class NET_DVR_DISPLAY_EFFECT_CFG extends Structure {
        public int dwSize;
        public NET_DVR_COLOR struColor = new NET_DVR_COLOR();
        public byte[] byRes = new byte[32];
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "struColor", "byRes");
    ...
    public static class SYS_TRANS_PARA extends Structure {
        public byte[] pSrcInfo;
        public int dwSrcInfoLen = 40;
        public byte enTgtType;
        public byte[] byRes = new byte[3];
        public int dwTgtPackSize;

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("pSrcInfo", "dwSrcInfoLen", "enTgtType", "byRes", "dwTgtPackSize");
        }
    }

    public static class NET_DVR_LIMIT_ANGLE extends Structure {
        public byte byEnable;
        public byte[] byRes1 = new byte[3];
        public NET_DVR_PTZPOS struUp = new NET_DVR_PTZPOS();
        public NET_DVR_PTZPOS struDown = new NET_DVR_PTZPOS();
        public NET_DVR_PTZPOS struLeft = new NET_DVR_PTZPOS();
        public NET_DVR_PTZPOS struRight = new NET_DVR_PTZPOS();
        public byte[] byRes2 = new byte[20];


        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("byEnable", "byRes1", "struUp", "struDown", "struLeft", "struRight", "byRes2");
        }
    }
    ...
    public static class NET_DVR_PTZ_BASICPARAMCFG extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byProportionalPan", "byPresetFreezing", "byPresetSpeed", "byKeyboardCtrlSpeed",
                    "byAutoScanSpeed", "byZoomingSpeed", "byManualControlSpeed", "byPTZMotionTrack", "byRes");
        }
    ...
    public static class NET_DVR_TIME_TASK extends Structure {
        ...
        public byte[] byRes = new byte[3];
        public NET_DVR_SCHEDTASK[][] struTask = new NET_DVR_SCHEDTASK[7][10];
        public int parkTime;
        public byte[] byRes1 = new byte[64];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byTaskEnable", "byRes", "struTask", "parkTime", "byRes1");
        }
    }


    public static class NET_DVR_SCHEDTASK extends Structure {
        public NET_DVR_SCHEDTIME struSchedTime = new NET_DVR_SCHEDTIME();
        public int wAction;
        public int wActionNum;
        public byte[] byres = new byte[12];
    ...
    public static class NET_DVR_VOD_DRAWFRAME_PARA extends Structure {
        public NET_DVR_TIME_EX struTime = new NET_DVR_TIME_EX();
        public int dwDrawType;
        public byte[] byRes = new byte[128];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("struTime", "dwDrawType", "byRes");
        }
    }
    ...
    boolean NET_DVR_SetPlayBackESCallBack(int lPassiveHandle, cbPlayESDataCallBack cbPlayESDataCallBack, Pointer pUser);
    ...
    boolean NET_DVR_GetPTZCruise(int lUserID, int lChannel, int lCruiseRoute, Pointer lpCruiseRet);

    boolean NET_DVR_SetVideoEffect(int lUserID, int channel, int dwBrightValue, int dwContrastValue, int dwSaturationValue, int dwHueValue);
//
...
//	 boolean  NET_DVR_StopRealPlay(int lRealHandle);
    ...
    boolean NET_DVR_SetPatrolLimitAngle(int lUserID, int lChannel, int lPatrolIndex, NET_DVR_LIMIT_ANGLE lpLimitAngle);

    boolean NET_DVR_SetPositionLimitAngle(int lUserID, int lChannel, int lPatrolIndex, NET_DVR_LIMIT_ANGLE lpLimitAngle);


    boolean NET_DVR_RemoteControl(int lUserID, int dwCommand, Pointer lpInBuffer, int dwInBufferSize);

    boolean NET_DVR_PlayBackControl(int lPlayHandle, int dwControlCode, int dwInValue,
                                    IntByReference LPOutValue);

    boolean NET_DVR_PlayBackControl_V40(int lPlayHandle,
                                        int dwControlCode, Pointer lpInBuffer, int dwInLen,
                                        Pointer lpOutBuffer, int lpOutLen);

    boolean NET_DVR_SaveRealData_V30(int lRealHandle, int dwTransType, String sFileName);

    boolean NET_DVR_CaptureJPEGPicture(int lUserID,
                                       int lChannel, NET_DVR_JPEGPARA lpJpegPara,
                                       String sPicFileName);
    ...
    public interface cbPlayESDataCallBack extends Callback {
        public void invoke(int lPlayHandle, NET_DVR_PACKET_INFO_EX lpDeviceinfo, Pointer pUser);
    }
