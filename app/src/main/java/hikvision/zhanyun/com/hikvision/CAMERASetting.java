...
public class CAMERASetting {
    public static class CameraConfig {
        ...
        public byte focusMode = 1;  // 聚焦模式：0:半自动，1:自动  默认自动
        ...
        public String toString() {
            return String.format("降噪模式:%d 增益控制:%d 聚焦模式:%d 背光补偿开关:%d 强光抑制开关:%d 电子透雾开关:%d 低照度开关:%d 视频丢失告警:%d 遮挡告警:%d 失焦告警:%d 花屏告警:%d 噪点告警:%d", /////
                    denoiseMode, gainControl, focusMode, backLightCom, strongLightSup, electronicFog, lowLight, videoLoss, videoBlock, videoOutFocus, videoScreenDist, videoNoise); /////
        }
    }
