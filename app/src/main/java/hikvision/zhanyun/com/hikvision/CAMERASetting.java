...
public class CAMERASetting {
    public static class CameraConfig {
        ...
        public byte ratioLimit = 0;  // 倍率限制：0:无倍率，1:42，2:84，3:168，4:336，5:504，6:672  默认无倍率 ///
        ...
        public String toString() {
            return String.format("降噪模式:%d 增益控制:%d 聚焦模式:%d 日夜模式:%d 倍率限制:%d 背光补偿开关:%d 强光抑制开关:%d 电子透雾开关:%d 低照度开关:%d 宽动态开关:%d 视频丢失告警:%d 遮挡告警:%d 失焦告警:%d 花屏告警:%d 噪点告警:%d", /////
                    denoiseMode, gainControl, focusMode, dayAndNightMode, ratioLimit, backLightCom, strongLightSup, electronicFog, lowLight, wideDynamic, videoLoss, videoBlock, videoOutFocus, videoScreenDist, videoNoise); /////
        }
    }
